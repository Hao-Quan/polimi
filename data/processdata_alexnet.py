...
train_data.to_hdf("data_training_test_alexnet.h5", "train_data")
test_data.to_hdf("data_training_test_alexnet.h5", "test_data")
train_label.to_hdf("data_training_test_alexnet.h5", "train_label")
test_label.to_hdf("data_training_test_alexnet.h5", "test_label")
